...
function App(){
  ...
  return(
    <>
    <div className="h-full w-full bg-gradient-to-tr from-jaguar-950 from-40% to-jaguar-800">
    <p className="font-Akira text-tiny tracking-widest text-jaguar-200 absolute top-2 left-8">MINIMAL BIO {">"}</p>
    <Marquee speed={100} className="absolute top-[200px]">
    ...
    <p className="font-Akira text-5xl text-black-50 tracking-wide">Abdul Quddus</p>
    <p className="text-sm font-Poppins text-jaguar-50 z-10 absolute mt-2"> MERN STACK DEVELOPER</p>
    </div>
